    ...
    <div className="max-w-3xl mx-auto">
      ...
      {loading ? (
        <p className="text-center py-12 text-gray-600 dark:text-gray-400">
          Loading your expenses from cloud...
        </p>
      ) : (
        <>
          {/* Form */}
          ...
          <div className="mb-6">
            ...
            <select
              ...
              className="w-full md:w-64 px-4 py-2 border rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
          ...
          {filteredAndSortedExpenses.length === 0 ? (
            <p className="text-center text-gray-500 dark:text-gray-400 py-12">
              {searchQuery || selectedCategory
                ...
                : 'No expenses added yet — add your first one!'}
            </p>
          ) : (
    ...
    <main className="min-h-screen p-6 md:p-12 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-2xl font-semibold mb-4">
            ...
            <p className="text-center py-12">Loading your expenses from cloud...</p>
          )}
        </div>
